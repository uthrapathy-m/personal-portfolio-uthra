...
export const ABOUT = {
  ...
  description: `I'm a results-driven DevOps Engineer with expertise in automating deployment pipelines and managing cloud infrastructure. I help organizations accelerate their software delivery through CI/CD implementation, container orchestration, and infrastructure as code. My experience spans across AWS, Azure, Docker, Kubernetes, and Terraform to build reliable, scalable systems that reduce deployment time and increase operational efficiency.`
}
