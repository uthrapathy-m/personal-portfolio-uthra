...
export function CareerItem({ link, company, jobs, badges, id }: CareerProps & { id: number }) {
  ...
  return (
    ...
    >
      ...
      <div className="h-full bg-white/10 backdrop-blur-lg rounded-xl shadow-lg border border-white/20 px-5 sm:px-6 py-5 sm:py-6 hover:bg-white/15 transition-all duration-300 hover:shadow-xl hover:border-purple-400/30">
        {/* Company Name & Badge */}
        ...
        {/* View More Button - Links to Detail Page */}
        <motion.div
          whileHover={{ scale: 1.05 }}
          whileTap={{ scale: 0.97 }}
